								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.question_title}</td>
											<td class='center'>${var.hy_label}</td>
											<td class='center'>${var.fx_label}</td>
											<td class='center'>${var.zn_label}</td>
											<td class='center'>${var.jn_label}</td>
											<td class='center'>${var.question_price}</td>
											<td class='center'>${var.spread}</td>
											<td class='center'>${var.question_state}</td>
