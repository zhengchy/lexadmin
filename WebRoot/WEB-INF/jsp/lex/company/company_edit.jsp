				...
				<div class="row">
					...
					<form action="company/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">使用数:</td>
								<td><input type="number" name="USE_COUNT" id="USE_COUNT" value="${pd.USE_COUNT}" maxlength="32" placeholder="这里输入使用数" title="使用数" style="width:98%;"/></td>
							</tr>
							<tr>
