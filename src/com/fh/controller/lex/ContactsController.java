...
public class ContactsController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("lex/contacts/contacts_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("lex/contacts/contacts_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var2", varOList.get(i).getString("friend_user_id"));	    //2
			vpd.put("var3", varOList.get(i).getString("create_time"));	    //3
			vpd.put("var4", varOList.get(i).getString("name_note"));	    //4
			vpd.put("var5", varOList.get(i).getString("contacts_group_id"));	    //5
			vpd.put("var6", varOList.get(i).getString("picture_id"));	    //6
			vpd.put("var7", varOList.get(i).getString("desc"));	    //7
			varList.add(vpd);
		}
