...
public class QuestionController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("lex/question/question_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("lex/question/question_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var3", varOList.get(i).getString("hy_label"));	    //3
			vpd.put("var4", varOList.get(i).getString("fx_label"));	    //4
			vpd.put("var5", varOList.get(i).getString("zn_label"));	    //5
			vpd.put("var6", varOList.get(i).getString("jn_label"));	    //6
			vpd.put("var7", varOList.get(i).get("question_price").toString());	//7
			vpd.put("var8", varOList.get(i).getString("spread"));	    //8
			vpd.put("var9", varOList.get(i).getString("question_state"));	    //9
